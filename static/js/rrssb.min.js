+ function (t, e, i) {
    ...
    var s = function () {
        ...
        o = function () {
            e(".rrssb-buttons").each(function (t) {
                ...
                if (c === r.length) {
                    var d = 42 * c,
                        u = i.width();
                    u > d + o && (i.removeClass("small-format"), s.eq(0).removeClass("small"), h())
                } else {
        ...
        h = function () {
            e(".rrssb-buttons").each(function (t) {
                var i, s, a, l, o, c = e(this),
                    h = e("li", c),
                    d = h.filter(".small"),
                    u = d.length;
                u > 0 && u !== h.length ? (c.removeClass("small-format"), d.css("width", "42px"), a = 42 * u, i = h.not(".small").length, s = 100 / i, o = a / i, r.calc === !1 ? (l = (c.innerWidth() - 1) / i - o, l = Math.floor(1e3 * l) / 1e3, l += "px") : l = r.calc + "(" + s + "% - " + o + "px)", h.not(".small").css("width", l)) : u === h.length ? (c.addClass("small-format"), n()) : (c.removeClass("small-format"), n())
            }), l()
        },
        d = function () {
            e(".rrssb-buttons").each(function (t) {
        ...
        m = function (e, r, s, a) {
            var n = t.screenLeft !== i ? t.screenLeft : screen.left,
                ...
                h = o / 2 - s / 2 + n,
                d = c / 3 - a / 3 + l,
                u = t.open(e, r, "scrollbars=yes, width=" + s + ", height=" + a + ", top=" + d + ", left=" + h);
            u && u.focus && u.focus()
        },
        f = function () {
            var t = {};
